...
class Config(object):
    ...
    SESSION_COOKIE_NAME = 'fbe_session'
    ...
    # Stripe 
    PUBLISHABLE_KEY = 'sk_test_NBbAQtbFxS6HWKVIMHIDWNeI'
    SECRET_KEY = 'pk_test_fNXeuUi5BY2P7hAr8P1Vl7Tl'

    DEFAULT_CHARGE_AMOUNT = 525
    DEFAULT_CHARGE_DESCRIPTION = "Fbe"